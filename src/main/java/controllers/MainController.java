...
public class MainController implements Initializable {
    ...
    void recolor(Pane pane,Button button) {
        ...
        listAnimeButton.setStyle("-fx-background-color: #cccccc;");
        watchingButton.setStyle("-fx-background-color: #cccccc;");
        willWatchButton.setStyle("-fx-background-color: #cccccc;");
        watchedButton.setStyle("-fx-background-color: #cccccc;");
